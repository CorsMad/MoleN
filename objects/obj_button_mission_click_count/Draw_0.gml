...
draw_sprite_stretched(spr_planet_hp,0,          x+52,y+60,(click_current/click_max)*(984-96),90)
draw_sprite_stretched(spr_planet_progress_bar,0,x+32,y+42,984-64,112)

scr_txt_transform(x+984/2,y+64,"кликов до бонуса " + string(click_current) + " / " + string(click_max),2,2,c_white);
} else {
	if ad_counter = 5{
